...
{
    internal class SanitizedSolutionExportPathTextBoxView
    {
        private readonly TextBox component;
        public SanitizedSolutionExportPathTextBoxView(Component component)
        {
            this.component = (TextBox)component;

            EventBusSingleton.Instance.disableUiElements += DisableComponent;
            EventBusSingleton.Instance.setSanitizedSolutionPath += SetSanitizedSolutionZipFilePath;
        }

        private void SetSanitizedSolutionZipFilePath(string solutionToSanitizePath)
        {
